# conway1.588.1550-ci — test-models, rc-regression baseline
...
97 models measured. `conway1.560.1539-ci_1.588.1550_delta.csv` diffs this run against `../conway1.560.1539-ci_test-models/`.
